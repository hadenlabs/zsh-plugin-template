...
function plugin-template::dependences {
    message_info "Installing dependences for ${PLUGIN_TEMPLATE_PACKAGE_NAME}"
    message_success "Installed dependences for ${PLUGIN_TEMPLATE_PACKAGE_NAME}"
}

function plugin-template::post_install {
    message_info "Post Install ${PLUGIN_TEMPLATE_PACKAGE_NAME}"
    message_success "Success Install ${PLUGIN_TEMPLATE_PACKAGE_NAME}"
}
...
function bw::search {
    ...
    echo "${PLUGIN_TEMPLATE_MESSAGE_COPIED}"
    zle accept-line
}